<div class="projects-container">
	<h1>Fresh CN<span class="drop-down-arrow-open"><i class="fas fa-chevron-down"></i></span></h1>
	<div class="needed-while-hiding">
		...
		<div class="a-little-inside">
			<ul class="list-without-bullets">
				...
				<li><span>Official Website: </span><a href="https://cn.fresh.com">cn.fresh.com</a></li>
			</ul>
		</div>
	</div>
</div>